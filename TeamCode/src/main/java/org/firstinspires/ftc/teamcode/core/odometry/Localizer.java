package org.firstinspires.ftc.teamcode.core.odometry;
...
public final class Localizer {
    ...
    // Đơn vị nội bộ: cm (xCm, yCm). JSON draw-path dùng mm — loader chuyển mm→cm trước khi gọi setPose/goToPosition.
