...
public final class LiftingSequenceConfig {
    ...
    private LiftingSequenceConfig(int version, Map<String, Double> n, Map<String, Boolean> b, Map<String, Factory> factories, String fingerprint) {
    ...
    static LiftingSequenceConfig create(int v, Map<String,Double> n, Map<String,Boolean> b, Map<String,Factory> f, String fp) { return new LiftingSequenceConfig(v,n,b,f,fp); }
}
