...
public final class LiftingSequenceConfigTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        check("version",c.version==1); check("calibration",c.lift2Steps==5625); check("factories",c.factoryFor("01").placement.x==120); check("fingerprint",c.fingerprint.length()==8); check("identities",c.webcam1Identity.equals("webcam1")&&c.webcam2Identity.equals("webcam2"));
        ...
        rejects("malformed",json.substring(0,json.length()-1));
