...
public final class LiftingSequenceOpMode extends LinearOpMode {
    @Override public void runOpMode() throws InterruptedException {
        ...
        final LiftingSequenceStateMachine.CameraResult cameras = new LiftingSequenceStateMachine.CameraResult() {
            public boolean fresh(long n) { return false; }
            public boolean valid() { return false; }
            public boolean stableLeftTarget() { return false; }
            public double leftDxPx() { return Double.NaN; }
        };
