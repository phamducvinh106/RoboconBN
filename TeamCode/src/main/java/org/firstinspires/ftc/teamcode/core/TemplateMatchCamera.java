 ...
 *
 * Cách dùng (giống hệt SingleTargetCamera):
 * <pre>{@code
 *   TemplateMatchCamera cam = new TemplateMatchCamera(
 *       hwMap, "Webcam 1", true, "target.png");
 *   cam.startAsync();
 *
...
public final class TemplateMatchCamera {
    ...
    public TemplateMatchCamera(
        ...
        pipeline = new TemplateMatchPipeline(targetAssetName);
    ...
    TemplateMatchCamera(String targetAssetName) {
        this.webcam = null;
        this.pipeline = new TemplateMatchPipeline(targetAssetName);
    }
    ...
    static final class TemplateMatchPipeline extends OpenCvPipeline {
        ...
        // ---------- Temporal filter (identical to SingleTargetCamera) ----------
        ...
        TemplateMatchPipeline(String targetAssetName) {
